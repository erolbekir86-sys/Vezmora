(() => {
  ...
  const copy = {
    sv: {
      ...
      'integrations.eyebrow':'INTEGRATIONER','integrations.title':'Vexmera arbetar med verktygen du redan använder.','integrations.connected':'Privat beta','integrations.pending':'Privat beta · API-godkännande krävs','integrations.soon':'Kommer snart',
    ...
    en: {
      ...
      'how.eyebrow':'HOW IT WORKS','how.title':'From data to decisions in three steps.','how.body':'Connect your channels and let Vexmera build a clearer picture of what works.','how.step1':'Connect your channels','how.step1Body':'Bring advertising, social and commerce data into one shared view.','how.step2':'Vexmera analyzes','how.step2Body':'AI looks for anomalies, patterns, and opportunities with the highest business value.','how.priority':'PRIORITY','how.action':'Increase budget','how.impact':'Expected impact +18%','how.step3':'Act with clarity','how.step3Body':'Get recommendations that are understandable, prioritized, and actionable.',
      ...
      'integrations.eyebrow':'INTEGRATIONS','integrations.title':'Vexmera works with the tools you already use.','integrations.connected':'Private beta','integrations.pending':'Private beta · API approval required','integrations.soon':'Coming soon',
