...
def beta_safety_snapshot() -> dict[str, object]:
    ...
    return {
        ...
        "notes": [
            ...
            "Production transport readiness requires VEZMORA_APP_URL to be a plain HTTPS origin with no credentials, path, query or fragment; malformed configured origins fail closed in browser mutation protection.",
